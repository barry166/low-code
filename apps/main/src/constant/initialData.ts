...
export const initialData = {
  ...
  components: {
    ...
    component1: { id: "component1", type: "button", content: "Some image" },
    component2: { id: "component2", type: "email", content: "Some email" },
    component3: { id: "component3", type: "name", content: "Some name" },
    component4: { id: "component4", type: "input", content: "Some phone" },
    component5: { id: "component5", type: "input", content: "last one phone" },
    component6: { id: "component6", type: "input", content: "last phone" },
  },
};
